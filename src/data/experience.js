export const experience = [
  {
    ...
    bullets: [
      ...
      "Implemented robust client-side validation, role-based UI rendering, and secure session management integrated with backend RESTful APIs, ensuring protected access to sensitive healthcare records and compliance with HIPAA standards.",
      "Optimized front-end performance using lazy loading, memoization, code splitting, and browser caching strategies to efficiently handle high-volume healthcare datasets and concurrent users.",
      "Engineered cloud-native Spring Boot Microservices using Spring MVC, Spring AOP, Hibernate ORM, and JPA, processing over 1.2M+ healthcare transactions monthly with 99.99% system availability.",
      "Designed modular microservices for claim validation, authorization routing, adjudication processing, and audit tracking following Microservices Architecture best practices.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Implemented advanced state management, performance optimization, and client-side validation to support high concurrent financial sessions with minimal latency.",
      "Enhanced frontend security by implementing token-based authentication and encrypted session handling mechanisms.",
      "Designed scalable backend microservices using Java 11, Spring Boot, Spring Security, Hibernate ORM, and JPA, supporting over 2M+ daily financial transactions.",
      "Developed microservices for credit scoring, underwriting workflows, loan approval routing, and fraud validation following Microservices Architecture principles.",
    ],
  },
  {
    title: "Full Stack Developer",
    ...
    bullets: [
      ...
      "Optimized frontend rendering and performance using RxJS and client-side caching strategies to support peak seasonal traffic loads.",
      "Implemented secure payment UI integrations aligned with transaction security compliance standards.",
      "Developed scalable backend microservices using Java, Spring Boot, Hibernate ORM, and JPA, supporting high-volume order processing during peak sales events.",
      "Designed backend services for inventory reconciliation, shipment tracking, and order validation following Microservices Architecture best practices.",
    ],
  },
  {
    title: "Full Stack Developer",
