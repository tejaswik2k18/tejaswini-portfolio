        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-4 justify-between">
          ...
          <div>
            ...
            <ul className="mt-3 flex items-center gap-4">
              <li>
                <a className="hover:text-primary transition-colors" href="https://www.linkedin.com/in/tejaswini916/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <FaLinkedin size={20} />
                </a>
              </li>
              <li>
